    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse" id="navbar">
            <ul class="nav navbar-nav">
                <li class=""><a href="#"><i class="glyphicon glyphicon-home"></i> 主页</a></li>
                <li class="dropdown">
                    <a aria-expanded="false" aria-haspopup="true" role="button" data-toggle="dropdown"
                       class="dropdown-toggle" href="#"><i class="glyphicon glyphicon-book"></i> 学习</a>
                    <ul class="dropdown-menu">
                        <li><a href="#">我的课程</a></li>
                        <li><a href="#">我的培训班</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a aria-expanded="false" aria-haspopup="true" role="button" data-toggle="dropdown"
                       class="dropdown-toggle" href="#"><i class="glyphicon glyphicon-edit"></i> 考试</a>
                    <ul class="dropdown-menu">
                        <li><a href="#">我的考试</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a aria-expanded="false" aria-haspopup="true" role="button" data-toggle="dropdown"
                       class="dropdown-toggle" href="#"><i class="glyphicon glyphicon-scale"></i> 社区</a>
                    <ul class="dropdown-menu">
                        <li><a href="#">动态</a></li>
                        <li><a href="#">问答</a></li>
                        <li><a href="#">群组</a></li>
