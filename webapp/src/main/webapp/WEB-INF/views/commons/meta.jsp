...
<meta name="description" content="e-Platform">
...
<link rel="stylesheet" href="${ctx}/static/libs/bootstrap/css/bootstrap-theme.css"/>
...
<script type="text/javascript" src="${ctx}/static/libs/jquery-migrate/jquery-migrate.js"></script>
...
<script type="text/javascript" src="${ctx}/static/libs/backbone/underscore.js"></script>
<script type="text/javascript" src="${ctx}/static/libs/backbone/backbone.js"></script>
